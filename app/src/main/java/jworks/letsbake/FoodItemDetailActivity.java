...
import jworks.letsbake.fragment.IngredientFragment;
import jworks.letsbake.fragment.StepsFragment;
import jworks.letsbake.fragment.VideoFragment;

/**
 * An activity representing a single FoodItem detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link FoodItemMainActivity}.
 */
public class FoodItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Check if viewpager exists, if yes then it is a phone else its tablet
