...
import jworks.letsbake.FoodItemMainActivity;
...
public class LetsBakeWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.lets_bake_widget);
        Intent intent = new Intent(context, FoodItemWidgetService.class);
        views.setRemoteAdapter(R.id.widget_stack_view, intent);
        //Pending Intent to Launch Main Activity
        Intent viewIntent = new Intent(context, FoodItemMainActivity.class);
